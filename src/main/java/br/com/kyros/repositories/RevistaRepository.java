...
public interface RevistaRepository extends JpaRepository<Revista, Long> {
    ...
    @Query("SELECT l FROM Revista l WHERE (:codigo is null or l.codigo = :codigo) AND "
            ...
            + "(:ano_edicao is null or l.ano_edicao LIKE %:ano_edicao%) AND l.ativo = true")
    
    public Page<Revista> buscarRevista(@Param("codigo") Long codigo, 
                                    @Param("titulo") String titulo,
                                    @Param("ano_edicao") String ano_edicao,
